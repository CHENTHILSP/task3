...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		// Enter Email
		WebElement typeEmail = driver.findElement(By.id("//input[@name='emailAddress']"));
		typeEmail.sendKeys("reshu008@gmail.com");

		// Click find leads button
		WebElement findLeadButton = driver.findElement(By.id("//button[text()='Find Leads']"));
		findLeadButton.click();

		// Capture name of First Resulting lead
		WebElement nameOfThe1stLead = driver.findElement(By.id("//a[text()='reshma'][1]"));
